...
<body>
    <div class="view">
        ...
        <div id="appartments">
            ...
            <div class="refresher">
                <form action="refreshFines.php">
                    <button type="submit" class="btn btn-default">Recalculate fines</button>
                </form>
            </div>
            <div class="filter">
                <form class="form-inline" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
...
<link rel="stylesheet" type="text/css" href="/Content/font-awesome/css/font-awesome.min.css" />
            ...
            <table id="exportTable" class="table table-hover" style="transform: scale(0.9); margin-left:-70px">
              ...
              <tbody>              
              <?php include 'updateAccountantFines.php';?>
              <?php include 'allAccountantFines.php';?>
              <?php include 'findAccountantFines.php';?>
