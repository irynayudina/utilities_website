        ...
        <div id="workers">
            ...
            <form class="form-inline" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="wi" placeholder="Enter worker id" name="wi">
                    </div>
                    <div class="form-group">
                      <label for="pwd">Forename:</label>
                      <input type="text" class="form-control" id="wf" placeholder="Enter forename" name="wf">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Name:</label>
                        <input type="text" class="form-control" id="wn" placeholder="Enter name" name="wn">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Middlename:</label>
                        <input type="text" class="form-control" id="wm" placeholder="Enter middlename" name="wm">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Password:</label>
                        <input type="text" class="form-control" id="wp" placeholder="Enter password" name="wp">
                    </div>
            ...
            <form class="form-inline" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                      <label for="email">Worker id:</label>
                      <input type="text" class="form-control" id="wiu" placeholder="Enter worker id" name="wiu">
                    </div>
                    <div class="form-group">
                      <label for="pwd">Forename:</label>
                      <input type="text" class="form-control" id="wfu" placeholder="Enter forename" name="wfu">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Name:</label>
                        <input type="text" class="form-control" id="wnu" placeholder="Enter name" name="wnu">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Middlename:</label>
                        <input type="text" class="form-control" id="wmu" placeholder="Enter middlename" name="wmu">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Password:</label>
                        <input type="text" class="form-control" id="wpu" placeholder="Enter password" name="wpu">
                    </div>
                    <button type="submit" class="btn btn-default">Update</button>
            </form>
            </div>
            <div class="deletor">
                <form class="form-inline" action="workerDelete.php" method="post">
                    <div class="form-group">
                        <label for="pwd">Worker id:</label>
                        <input type="text" class="form-control" id="widd" placeholder="Enter worker id" name="widd">
                    </div>
...
<link rel="stylesheet" type="text/css" href="/Content/font-awesome/css/font-awesome.min.css" />
            ...
            <table id="exportTable" class="table table-hover">
              ...
              <tbody>
              <?php include 'updateWorkers.php';?>
              <?php include 'allWorkers.php';?>
              <?php include 'workerSort.php';?>
